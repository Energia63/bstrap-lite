<?php
/**
 * Breadcrumb code borrowed from Daisy Blue theme https://wordpress.org/themes/daisy-blue/
 */
function bstrap_breadcrumbs() {
    ...
    if (is_home() || is_front_page()) {
        ...
        if ( get_query_var('paged') ) {
            ...
            echo __('Page', 'bstrap-lite') . ' ' . get_query_var('paged');
            if ( is_category() || is_day() || is_month() || is_year() || is_search() || is_tag() || is_author() ) echo ')';
        }
